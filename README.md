...
I am a final-year Bachelor of Computer Science (Information Systems) student at the **University of Malaya**. I specialize in building scalable backend systems, full-stack applications, and leveraging Google Cloud Platform (GCP) for modern DevOps workflows.
...
- **Frameworks & Libraries:** Next.js, React, Node.js, Express.js, REST APIs
- **Cloud & DevOps:** Google Cloud Platform (GCP), Docker, CI/CD, Git, GitHub
- **Databases & Tools:** Supabase, MongoDB, n8n Automation
- **Machine Learning & AI:** XGBoost, Scikit-learn, Hugging Face, Model Evaluation
